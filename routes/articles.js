...
router.get('/delete/all', async (req, res, next) => {
  await Article.deleteMany({ title: 'DELETE EVERYTHING' });
...
router.get('/create', (req, res, next) => {
  res.render('articles/form', { title: 'Create an SURVEY', article: {} });
});
...
router.get('/:id', findArticleByIdAndRenderPage('articles/display'));

router.get(
  '/:id/edit',
  findArticleByIdAndRenderPage('articles/form', { title: 'Edit survey information' })
);
